    ...
    Dialog(onDismissRequest = { onDismissRequest() }) {
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = manfaat,
                    onValueChange = { manfaat = it },
                    label = { Text(text = stringResource(id = R.string.manfaat)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(nama, manfaat) },
                        enabled = nama.isNotEmpty() && manfaat.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
